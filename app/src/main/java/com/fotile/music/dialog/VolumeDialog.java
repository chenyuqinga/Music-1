package com.fotile.music.dialog;
...
import com.fotile.music.widget.ThinBoldTextView;
...
public class VolumeDialog extends Dialog {
     ...
     * 音量显示
     */
    public ThinBoldTextView imgVolume;
    /**
     * 音量自定义View
     */
    ...
    public void init(){
        ...
        imgVolume = (ThinBoldTextView) findViewById(R.id.img_volume);
